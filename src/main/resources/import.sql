...
insert into despensa(id, localizacao, nome, cliente_id) values(1, 'Curitiba', 'Casa', 1);
insert into despensa(id, localizacao, nome, cliente_id) values(2, 'Floripa', 'Casa praia',2);
...
INSERT INTO favorita(cliente_id, receita_id) VALUES (2, 1);
