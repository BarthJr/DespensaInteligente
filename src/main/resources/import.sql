...
insert into categoria(id,nome) values(3, 'Para Deletar');
...
insert into produto_despensa(id, quantidade, validade, despensa_id, produto_id) values(1, 5.0, now(), 1, 1);
insert into produto_despensa(id, quantidade, validade, despensa_id, produto_id) values(2, 10.0, now(), 2, 2);
insert into produto_despensa(id, quantidade, validade, despensa_id, produto_id) values(3, 15.0, now(), 1, 1);
...
INSERT INTO medida(id, nome, valor) VALUES (2, 'test', 5.0);
